    ...
    return (
        <>
            ...
            <Form form={signUpForm} onSubmit={onSubmit}>
                ...
                <Checkbox name={'subscribeEmail'} label="Subscribe to Email Notification" checkedLabel="Yes" uncheckedLabel="No" orientation="horizontal" />
                <Checkbox name={'subscribePhone'} label={'Subscribe to Text Message'} checkedLabel="Yes" uncheckedLabel="No" orientation="horizontal" />
                <Input name={'email'} label={'Email'} required={subscribeEmail} />
                <Input name={'phoneNumber'} label={'Phone Number'} required={subscribePhone} />

                <Input name={'username'} label={'Username'} required={true} />
                <Input name={'password'} type="password" label={'Password'} required={true} />
                <Input name={'confirmPassword'} type="password" label={'Confirm Password'} required={true} />
