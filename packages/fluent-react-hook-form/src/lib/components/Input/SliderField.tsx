    ...
    return (
        <Controller
            ...
            render={({ field, fieldState }) => {
                ...
                const handleOnChange : SliderProps["onChange"] = (ev: React.ChangeEvent<HTMLInputElement>, data: SliderOnChangeData) => {
                    onChange(data.value);
                    sliderProps.onChange?.(ev, data);
                }

                const handleOnBlur : SliderProps["onBlur"]  = (ev: React.FocusEvent<HTMLInputElement>) => {
                    onBlur();
